export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'grantrimbi',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Grantrimbi',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'grantrimbi.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://grantrimbi.com',
