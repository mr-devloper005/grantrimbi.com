  ...
  return (
    <EditableSiteShell>
      <main>
        ...
        <div className="mx-auto w-full max-w-[var(--editable-container)] px-5 pt-10 sm:px-6 lg:px-8">
        ...
        <EditableHomeCta primaryTask={primaryTask} primaryRoute={primaryRoute} posts={primaryPosts} timeSections={timeSections} />
      </main>
    </EditableSiteShell>
  )
}
